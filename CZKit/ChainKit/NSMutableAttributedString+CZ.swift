...
public extension CZ where Base: NSMutableAttributedString {
    
    @discardableResult
    func addAttribute(_ name: NSAttributedString.Key, value: Any, range: NSRange) -> CZ {
        base.addAttribute(name, value: value, range: range)
        return self
    }
    
    @discardableResult
    func addAttributes(_ attrs: [NSAttributedString.Key : Any] = [:], range: NSRange) -> CZ {
        base.addAttributes(attrs, range: range)
        return self
    }
    
    @discardableResult
    func removeAttribute(_ name: NSAttributedString.Key, range: NSRange) -> CZ {
        base.removeAttribute(name, range: range)
        return self
    }
    
    @discardableResult
    func font(_ font: UIFont, range: NSRange? = nil) -> CZ {
    ...
    @discardableResult
    func systemFont(ofSize fontSize: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func boldSystemFont(ofSize fontSize: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func paragraphStyle(_ paragraphStyle: NSParagraphStyle, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func foregroundColor(_ foregroundColor: UIColor, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func backgroundColor(_ backgroundColor: UIColor, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func ligature(_ ligature: Int, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func kern(_ kern: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func strikethroughStyle(_ strikethroughStyle: Int, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func underlineStyle(_ underlineStyle: Int, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func strokeColor(_ strokeColor: UIColor, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func strokeWidth(_ strokeWidth: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func shadow(_ shadow: NSShadow, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func textEffect(_ textEffect: String, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func attachment(_ attachment: NSTextAttachment, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func link(_ link: URL, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func baselineOffset(_ baselineOffset: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func underlineColor(_ underlineColor: UIColor, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func strikethroughColor(_ strikethroughColor: UIColor, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func obliqueness(_ obliqueness: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func expansion(_ expansion: CGFloat, range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func writingDirection(_ writingDirection: [Int], range: NSRange? = nil) -> CZ {
        guard let range = range else {
    ...
    @discardableResult
    func verticalGlyphForm(_ verticalGlyphForm: Int, range: NSRange? = nil) -> CZ {
        guard let range = range else {
