...
public extension CZKit where Base: NSMutableAttributedString {
    ...
    @discardableResult
    func addAttribute(_ name: NSAttributedString.Key, value: Any, range: NSRange) -> CZKit {
    ...
    @discardableResult
    func removeAttribute(_ name: NSAttributedString.Key, range: NSRange) -> CZKit {
    ...
    @discardableResult
    func paragraphStyle(_ paragraphStyle: NSParagraphStyle, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func foregroundColor(_ foregroundColor: UIColor, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func backgroundColor(_ backgroundColor: UIColor, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func ligature(_ ligature: Int, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func kern(_ kern: CGFloat, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func strokeColor(_ strokeColor: UIColor, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func strokeWidth(_ strokeWidth: CGFloat, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func shadow(_ shadow: NSShadow, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func textEffect(_ textEffect: String, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func attachment(_ attachment: NSTextAttachment, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func link(_ link: URL, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func baselineOffset(_ baselineOffset: CGFloat, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func writingDirection(_ writingDirection: [Int], range: NSRange? = nil) -> CZKit {
        guard let range = range else {
    ...
    @discardableResult
    func verticalGlyphForm(_ verticalGlyphForm: Int, range: NSRange? = nil) -> CZKit {
        guard let range = range else {
